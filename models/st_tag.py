...
class ST_TAG(torch.nn.Module):
    """
    Spatio-Temporal Graph Attention Network as presented in https://ieeexplore.ieee.org/document/8903252
    """
    def __init__(self, in_channels, out_channels, n_nodes,  k, bias, normalize, dropout=0.0):
        """
        ...
        self.tag = TAGConv(in_channels=in_channels, out_channels=in_channels, n_nodes=n_nodes,
        k=k, bias=bias, normalize=normalize)
        ...
        # model = keras.models.Sequential([TCN(input_shape=(80, 1), nb_filters=256, return_sequences=True, dilations=[1, 2, 4, 8, 16, 32]),
