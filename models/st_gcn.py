...
# import models.GCNConvseifi as GCNConv
from models.GCNConvseifi import GCNConv

class ST_GCN(torch.nn.Module):
    """
    Spatio-Temporal Graph Attention Network as presented in https://ieeexplore.ieee.org/document/8903252
    """
    def __init__(self, in_channels, out_channels, n_nodes, dropout, improved, cached, add_self_loops, normalize, bias):
        """
        ...
        self.gcn = GCNConv(in_channels=in_channels, out_channels=in_channels,
            improved=improved, cached=cached, add_self_loops=add_self_loops, normalize=normalize, bias=bias)
